    ...
    <>
      <nav className="bg-white fixed w-full top-0 left-0 z-50">
        <div className="max-w-screen-xl mx-auto px-4 py-4 flex justify-between items-center relative">
          <div className="absolute left-1/2 transform -translate-x-1/2 text-4xl font-semibold tracking-wide hidden md:block">
          
          </div>
          {/*Escritorio*/}
          <div className="text-black hidden md:flex items-center justify-between w-full">
            {/*Navegación*/}
            <ul className="flex items-center space-x-6">
              <li>
                <Link
                  to="/"
                  className={`text-sm font-semibold transition duration-200 flex items-center ${isActive(
                    '/'
                  )}`}
                >
                  INICIO
              ...
              <li>
                <Link
                  to="/Productos"
                  className={`text-sm font-semibold text-black transition duration-200 flex items-center ${isActive(
                    '/Productos'
                  )}`}
                >
                  HOMBRE
            ...
            <div className="flex items-center space-x-4">
              {isAuthenticated ? (
                ...
                <button
                  ...
                  className="flex items-center text-black transition duration-200"
                  title="CERRAR SESIÓN"
                >
                  <svg
                ...
                <Link
                  to="/Login"
                  className="flex items-center text-black font-semibold transition duration-200"
              ...
              <div className="flex items-center">
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 text-black transition duration-200"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  {cartCount > 0 && (
                    <span className="ml-1 text-black font-bold w-2 h-5 flex items-center justify-center text-sm">
                      {cartCount}
                    </span>
                  )}
                </button>
    ...
    ></span>
         ...
         <button 
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 text-black transition-colors duration-200"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              {cartCount > 0 && (
                <span className="ml-1 text-black font-bold w-2 h-5 flex items-center justify-center text-xs">
                  {cartCount}
                </span>
              )}
            </button>
